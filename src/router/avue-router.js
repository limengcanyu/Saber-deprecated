...
RouterPlugin.install = function(vue, router, store, i18n) {
    console.log('RouterPlugin.install ================================');
    console.log('vue: ');
    console.log(vue);
    console.log('router: ');
    console.log(router);
    ...
    this.$router.$avueRouter = {
        ...
        getPath: function(params) {
            console.log('处理路由: ' + JSON.stringify(params));
        ...
        formatRoutes: function(aMenu = [], first) {
            console.log('动态路由 ===============================');
            console.log('aMenu: ' + JSON.stringify(aMenu) + ' first: ' + JSON.stringify(first));
            ...
            console.log('propsDefault: ' + JSON.stringify(propsDefault));

            if (aMenu.length === 0) return;

            for (let i = 0; i < aMenu.length; i++) {
                const oMenu = aMenu[i];
                console.log('oMenu: ' + JSON.stringify(oMenu));
